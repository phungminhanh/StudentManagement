...
public class CourseController {
	...
	public String saveCustomer(@Valid @ModelAttribute("course") Course theCourse
			,BindingResult theBindingResult, ModelMap  theModel) {
	...
	public String showFormForUpdate(@RequestParam("courseId") String theId,
			ModelMap theModel) {
