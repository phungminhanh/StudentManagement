...
public class StudentController {
	...
	public String saveStudent(@Valid @ModelAttribute("student") Student theStudent,BindingResult theBindingResult, ModelMap theModel,
		...
		// if having errors, return to the form that uses to input data of the student rather than update database
			...
			if (theCourse.getEnrollment()<=theCourse.getStudents().size()&&studentService.getStudent(theStudent.getId())==null) {
